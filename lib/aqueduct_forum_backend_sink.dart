import 'aqueduct_forum_backend.dart';
...
class AqueductForumBackendSink extends RequestSink {
  ...
  /// See bin/start.dart.
  AqueductForumBackendSink(Map<String, dynamic> opts) : super(opts) {
    AqueductForumBackendConfiguration configuration = opts[ConfigurationKey];
    ...
    authServer = new AuthServer<User, Token, AuthCode>(
        new AqueductForumBackendAuthDelegate());
  }
...
class AqueductForumBackendConfiguration extends ConfigurationItem {
  AqueductForumBackendConfiguration(String fileName) : super.fromFile(fileName);
